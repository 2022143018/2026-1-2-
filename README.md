...
본격적인 리뷰 감성 분석에 앞서, 두 OTT플랫폼의 글로벌 가입자 수를 살펴보면 시장의 지각변동과 유저들의 이탈·유입 흐름이 극명하게 드러났다.
<p align="center">
  <img src="ott_subscriber_chart.png" width="1000" alt="OTT Subscriber Chart"/>
</p>

Netflix는 년도별로 가입자수가 늘었다 줄었다 하지만 이탈하는 수가 더 많지는 않다.[출처](https://ir.netflix.net/financials/quarterly-earnings/default.aspx)

반면 Disney+는 코로나 펜데믹 시절 엄청난 가입자수 증가가 있었지만 펜데믹이 끝난후 이탈하는 고객들이 많은것을 알수있다.[출처](https://investors.thewaltdisneycompany.com/)
